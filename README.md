...
| ServerRoomFan | Système intelligent de surveillance et régulation thermique | Python, C |
| Interface d'images | Application d'édition et comparaison d'images avec filtres | Python |
...
- BUT Informatique — IUT de Laval *(en cours)*
